...
export const projects: Project[] = [
	...
	},
	{
		...
		gif: flashcards_gif,
		brief: {
			en: 'Flashcards fullstack app to help memorize information',
			fr: 'Application fullstack de cartes mémoire',
			pt: 'Aplicação fullstack de flashcards',
		},
		repo: 'https://github.com/jsantos42/Flashcards',
		field: ['Front End', 'Back End'],
		language: ['TypeScript'],
		framework: ['Next.js', 'React.js', 'Node.js', 'Express.js', 'Docker'],
		styling: ['Tailwind CSS'],
		db: ['MySQL'],
	...
	},
	{
		...
		field: ['Front End'],
		language: ['TypeScript'],
		framework: ['Next.js', 'React.js', 'Docker'],
		styling: ['Tailwind CSS'],
		db: undefined,
		testingFramework: undefined,
		date: ['2024-01'],
	...
	{
		title: 'Fast-Food Around Schools in Portugal',
		...
		repo: 'https://github.com/jsantos42/FastFoodAroundSchools',
		field: ['Datascience'],
		language: ['Python', 'R'],
		framework: undefined,
		styling: undefined,
